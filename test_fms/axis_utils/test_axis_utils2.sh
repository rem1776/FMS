...
TESTS_SUCCESS='--get-axis-modulo --get-axis-modulo-times --get-axis-cart --lon-in-range --frac-index --nearest-index-increasing --nearest-index-decreasing --axis-edges-increasing --axis-edges-decreasing --tranlon --interp-1d-1d --interp-1d-2d --interp-1d-3d'
