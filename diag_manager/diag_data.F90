...
use platform_mod
  ...
  INTEGER, PARAMETER :: time_min     = 1 !< The reduction method is min
  INTEGER, PARAMETER :: time_max     = 2 !< The reduction method is max
  INTEGER, PARAMETER :: time_sum     = 3 !< The reudction method is sum
  INTEGER, PARAMETER :: time_average = 4 !< The reduction method is avera
  INTEGER, PARAMETER :: time_rms     = 5 !< The reduction method is rms
  INTEGER, PARAMETER :: time_power   = 6 !< The reduction method is power
  INTEGER, PARAMETER :: time_diurnal = 7 !< The reduction method is diurnal
