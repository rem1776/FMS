...
real(kind=r8_kind), public, parameter :: PI_8  = 3.1415926535897931_r8_kind  !< Ratio of circle
                                                                             !! circumference to diameter [N/A]
...
real(kind=r8_kind), public, parameter :: GRAV_8 = 9.80665_r8_kind   !< Acceleration due to
                                                                    !! gravity [m/s^2] (REAL(KIND=8))
...
real(kind=8), public, parameter :: PI_8  = 3.14159265358979323846_r8_kind !< Ratio of circle
                                                                          !! circumference to diameter [N/A]
...
real, public, parameter :: CP_VAPOR = 4.0_r8_kind*RVGAS   !< Specific heat capacity of water
                                                          !! vapor at constant pressure [J/kg/deg]
...
real, public, parameter :: RHO_CP = RHO0*CP_OCEAN  !< (kg/m^3)*(cal/kg/deg C)(joules/cal) =
...
real, public, parameter :: RADCON = ((1.0E+02*GRAV)/(1.0E+04*CP_AIR))*SECONDS_PER_DAY !< Factor used to convert flux
                                                                                  !! divergence to heating rate in
                                                                                  !! degrees per day [deg sec/(cm day)]
...
real, public, parameter :: C2DBARS   = 1.e-4_r8_kind   !< Converts rho*g*z (in mks) to dbars:
